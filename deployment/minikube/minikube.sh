...
kubectl create secret tls ca-key-pair --namespace siembol --cert=$HOME/Library/ApplicationSupport/mkcert/rootCA.pem --key=$HOME/Library/ApplicationSupport/mkcert/rootCA-key.pem
kubectl apply -f - <<EOF
