...
public class NortemSyslogParser implements NortemParser {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NortemSyslogParser.class);
    ...
    private NortemSyslogParser(Builder builder) {
