...
public enum ErrorResolutions {
    ...
    CONCURRENT_USERS("Siembol UI can be used by multiple users in parallel. Try to reload UI, modify and replay your request"),
    VALIDATION("Try to inspect error message and modify your changes. Ask administrators for help if the problem persists");
