...
- `storm.attributes` - Global settings for storm attributes used if they are not overridden
    ...
    - `kafka.spout.properties` - Defines the kafka consumer attributes for the kafka spout such as group.id, protocol, see `https://kafka.apache.org/0102/documentation.html#consumerconfigs`
