...
_Ability to integrate with other systems._ While the core functionality of Metron was great, we always yearned for more integration with the growing ecosystem of SIEM-related projects.  Currently, Siembol integrates with other systems such as [Jira](https://www.atlassian.com/software/jira), [Hive](https://hive.apache.org/), [Cortex](https://www.cortex-ia.com/our-software/), [ELK](https://www.elastic.co/what-is/elk-stack), and [LDAP](https://ldap.com/). Beyond that, Siembol’s plugin interface allows a custom integration with other systems used in incident response.
