...
- [3. How Siembol Improves upon Metron](#how-siembol-improves-upon-metron)
    ...
    * [3.6 Easy Installation to Try Out with Prepared Docker Images and Helm Charts](#easy-installation-to-try-out-with-prepared-docker-images-and-helm-charts)
- [4. Use Cases](#use-cases)
  * [4.1 SIEM Log Collection Using Open Source Technologies](#siem-log-collection-using-open-source-technologies)
  * [4.2 Detection Tool for Detection of Leaks and Attacks on Infrastructure](#detection-tool-for-detection-of-leaks-and-attacks-on-infrastructure)
