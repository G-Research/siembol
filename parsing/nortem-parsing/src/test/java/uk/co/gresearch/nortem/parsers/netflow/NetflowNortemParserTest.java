...
public class NetflowNortemParserTest {
    ...
    private NortemNetflowParser netflowParser;
    ...
    @Before
    public void setUp() {
        netflowParser = new NortemNetflowParser();
    }
    ...
    public void testUnknownTemplate() throws IOException {
        ...
        Assert.assertTrue((Boolean)unknownTemplate.get(NortemNetflowParser.NETFLOW_UNKNOWN_TEMPLATE));
        Assert.assertEquals( "0", unknownTemplate.get(NortemNetflowParser.NETFLOW_SOURCE_ID));
        Assert.assertEquals("10.16.22.254", unknownTemplate.get(NortemNetflowParser.NETFLOW_GLOBAL_SOURCE));
    }
