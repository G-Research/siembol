...
public class SerializableNortemParserTest {
    /**
     *   {
     *     "parser_name" : "test",
     *     "parser_version" : 1,
    ...
    **/
    ...
    public void serializableTest() throws Exception {
        SerializableNortemParser original = new SerializableNortemParser(simpleGenericParser);
        ...
        SerializableNortemParser clone = SerializationUtils.clone(original);
    ...
    public void serializableInvalidTest() throws Exception {
        SerializableNortemParser original = new SerializableNortemParser("INVALID");
    }
}
