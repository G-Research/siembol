...
public class SingleApplicationParser extends ParsingApplicationParser {
    ...
    private final NortemParserWrapper parser;
    ...
    public static abstract class Builder<T extends SingleApplicationParser> extends
        ...
        protected NortemParserWrapper parser;

        public Builder<T> parser(String topic, SerializableNortemParser nortemParser) throws Exception {
            final RouterCondition alwaysMatch = x -> true;
            parser = new NortemParserWrapper(alwaysMatch, nortemParser, topic);
            return this;
        }
