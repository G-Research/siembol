...
public class ParsingApplicationBoltTest {
    ...
    public void testMatchRule() throws IOException {
       parsingApplicationBolt.execute(tuple);
        ...
        Assert.assertEquals("RAW_LOG", parsed.get(NortemMessageFields.ORIGINAL.toString()));
        Assert.assertEquals("single", parsed.get(NortemMessageFields.SENSOR_TYPE.toString()));
    ...
    public void testExceptionMetadata() throws Exception {
        ...
        Assert.assertEquals("error", parsed.get(NortemMessageFields.SENSOR_TYPE.toString()));
