...
@Attributes(title = "correlation rules", description = "Correlation rules for Nikita real-time correlation alert matching")
public class CorrelationRulesDto {
    public CorrelationRulesDto() {
        TagsDto tag = new TagsDto();
        tag.setTagName(NikitaTags.DETECTION_SOURCE_TAG_NAME.toString());
        tag.setTagValue(NikitaTags.NIKITA_CORRELATION_DETECTION_SOURCE_TAG_VALUE.toString());
