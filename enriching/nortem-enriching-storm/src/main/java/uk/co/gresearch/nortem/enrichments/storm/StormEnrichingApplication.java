...
public class StormEnrichingApplication {
    ...
    public static StormTopology createTopology(StormEnrichmentAttributes attributes,
                                               ...
                                               NortemFileSystemFactory nortemFileSystemFactory) {
        ...
        builder.setBolt(ENRICHING_ENGINE_BOLT_NAME,
                new EnrichmentEvaluatorBolt(attributes, zookeperConnectorFactory),
        ...
        builder.setBolt(MEMORY_ENRICHING_BOLT_NAME,
                new MemoryTableEnrichmentBolt(attributes, zookeperConnectorFactory, nortemFileSystemFactory),
