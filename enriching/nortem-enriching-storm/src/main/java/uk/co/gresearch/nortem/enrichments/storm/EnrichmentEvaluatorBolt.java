...
import uk.co.gresearch.nortem.enrichments.compiler.EnrichmentCompilerImpl;
...
import uk.co.gresearch.nortem.enrichments.storm.common.EnrichmentCommands;
...
public class EnrichmentEvaluatorBolt extends BaseRichBolt {
    ...
    private static final String INIT_EXCEPTION_MSG_FORMAT = "Enriching rule engine exception: %s during initialising nikita engine";
